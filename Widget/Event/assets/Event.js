...
var IpWidget_Event = function () {
    ...
    var openPopup = function () {
        ...
        $('#ipWidgetEventPopup').remove(); //remove any existing popup. This could happen if other widget is in management state right now.

        //get popup HTML using AJAX. See AdminController.php widgetPopupHtml function
        var data = {
            aa: 'Event.widgetPopupHtml',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var $popup = $('#ipWidgetEventPopup .ipsModal');
                $popup.modal();
